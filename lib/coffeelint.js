...
(function() {
  var ASTLinter, CoffeeScript, ERROR, IGNORE, LexicalLinter, LineLinter, RULES, WARN, block_config, coffeelint, createError, defaults, extend, mergeDefaultConfig, parseCoffeeScriptError, regexes,
    __slice = [].slice,
  ...
  parseCoffeeScriptError = function(coffeeError) {
  ...
  LexicalLinter = (function() {
    ...
    function LexicalLinter(source, config) {
      ...
      try {
        ...
        this.errors.push(parseCoffeeScriptError(coffeeError));
      }
      this.config = config;
      this.i = 0;
      this.tokensByLine = {};
    ...
    LexicalLinter.prototype.lint = function() {
      var error, i, token, _i, _len, _ref;
